...
export default {
  ...
  actions: {
    createAccount({ commit }, { username, password1, password2, email ,mobil,language_prefered}) {
      
      commit(REGISTRATION_BEGIN);
      return auth.createAccount(username, password1, password2, email,mobil,language_prefered)
